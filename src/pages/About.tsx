        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-end">
          ...
          <div className="space-y-6">
            ...
            <p className="text-cyan-400 text-lg lg:text-xl max-w-md">
              <span className="font-semibold text-yellow-400">GoLive24h</span> exists to solve a common
              <br/>
              problem in digital work: misalignment.
            </p>
          </div>

          {/* Right Column - Description Text */}
          <div className="space-y-6 text-gray-300 xl:relative right-20">
            <p className="text-base lg:text-lg leading-relaxed xl:w-[140%]">
              ...
              <br/>
              together — and pay for it later.
            </p>
            
            <p className="text-base lg:text-lg leading-relaxed xl:w-[140%]">
              We help organizations avoid that by building digital foundations where strategy,
              <br/>
              design, and systems are aligned from the start — and built to hold up as the
              <br/>
              business grows.
            </p>
          </div>
